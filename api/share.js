...
const shareWarmCache = /* @__PURE__ */ new Map();
const SHARE_CACHE_TTL = 15 * 60 * 1e3;
...
<body>
  ...
  <footer style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #e2e8f0; font-size: 12px; color: #64748b; text-align: center;">
    &copy; ${(/* @__PURE__ */ new Date()).getFullYear()} NP News Metro. All rights reserved. | <a href="${SITE_ORIGIN}/about" style="color: #64748b;">About Us</a> | <a href="${SITE_ORIGIN}/privacy" style="color: #64748b;">Privacy Policy</a> | <a href="${SITE_ORIGIN}/terms" style="color: #64748b;">Terms</a> | <a href="${SITE_ORIGIN}/sitemap.xml" style="color: #64748b;">Sitemap</a>
  </footer>
</body>
</html>`;
    ...
    if (cleanCategory === "videos" && cleanSlug) {
      try {
        const { data: vData } = await supabase.from("videos").select("title, description, thumbnail_url, youtube_url, published_at, slug").eq("slug", cleanSlug).maybeSingle();
        if (vData) {
          mediaItem = {
            title: vData.title,
            ...
            publishedAt: vData.published_at || (/* @__PURE__ */ new Date()).toISOString(),
    ...
    if (!mediaItem && cleanSlug) {
      try {
        ...
        if (data) {
          ...
          mediaItem = {
            ...
            modifiedAt: data.updated_at || data.published_at || (/* @__PURE__ */ new Date()).toISOString(),
            author: authorName2,
      ...
      if (!mediaItem) {
        ...
        if (mockArticle) {
          mediaItem = {
            ...
            slug: cleanSlug,
            publishedAt: mockArticle.publishedAt || (/* @__PURE__ */ new Date()).toISOString(),
            modifiedAt: mockArticle.publishedAt || (/* @__PURE__ */ new Date()).toISOString(),
      ...
      if (!mediaItem && FALLBACK_SLUGS[cleanSlug]) {
        ...
        mediaItem = {
          ...
          caption: f.title,
          slug: cleanSlug,
          publishedAt: f.publishedAt || (/* @__PURE__ */ new Date()).toISOString(),
          modifiedAt: f.publishedAt || (/* @__PURE__ */ new Date()).toISOString(),
    ...
    const publishedIso = mediaItem?.publishedAt || (/* @__PURE__ */ new Date()).toISOString();
...
<body>
  ...
  <footer>
    <p>&copy; ${(/* @__PURE__ */ new Date()).getFullYear()} NP News Metro. Real News. Real Impact. All rights reserved.</p>
    <p>
